 ...
 */
public class RecyclerViewAdapterPost extends RecyclerView.Adapter<RecyclerView.ViewHolder>  implements IApiResponse {
    ...
    public RecyclerViewAdapterPost(Context context, ArrayList<GetCartListDataModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_recycler_intgredietns, viewGroup, false);
